...
namespace _04_06_20_DeepWiseCloning
{
    ...
    {      
        ...
        /// <param name="t"></param>
        /// <returns></returns>
        static public T MemberWiseDeepCloneWithRecursiveMemberWiseClone<T>(this T t) where T : class, new()
        {
        ...
        /// </param>
        /// <returns></returns>
        public static T MemberWiseDeepClone<T>(this T original, int recursiveIterationsStopper)
        {
        ...
        public static T MemberWiseDeepClone<T>(this T original)
        {
        ...
        private static bool CatchCircularReferences()
        {
            ...
            if (_fieldsStore.Count >= 2)
            {
                ...
                {
                    if (lastSuitcase[i].Keys.First() != null && !lastSuitcase[i].Values.First().IsValueType && lastSuitcase[i].Values.First() != typeof(String))
                    {
